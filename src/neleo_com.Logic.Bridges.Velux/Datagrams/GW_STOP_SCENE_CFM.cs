...
namespace neleo_com.Logic.Bridges.Velux.Datagrams {
    ...
    /// <summary>
    ///   Confirmation for <see cref="GW_STOP_SCENE_REQ"/>.</summary>
    public sealed class GW_STOP_SCENE_CFM : Klf200Datagram, IKlf200DatagramSessionResponse {

        /// <summary>
        ///   Initialize the command.</summary>
        public GW_STOP_SCENE_CFM() : base(Klf200Command.GW_STOP_SCENE_CFM, 3) { }
        ...
        /// <summary>
        ///   Indicates if the corresponding <see cref="GW_STOP_SCENE_REQ"/> command is accepted 
